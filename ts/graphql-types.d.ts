...
export type IndexImagesQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexImagesQueryQuery = (
  { __typename?: 'Query' }
  & { slider: (
    { __typename?: 'FileConnection' }
    & { nodes: Array<(
