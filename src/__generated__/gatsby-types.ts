...
type GuideQueryQueryVariables = Exact<{ [key: string]: never; }>;


type GuideQueryQuery = { readonly mdx: Maybe<Pick<Mdx, 'body' | 'tableOfContents'>> };

type IndexImagesQueryQueryVariables = Exact<{ [key: string]: never; }>;


type IndexImagesQueryQuery = { readonly slider: { readonly nodes: ReadonlyArray<(
      Pick<File, 'id'>
      & { readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }
    )> }, readonly footer: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> };

type TeamImagesQueryQueryVariables = Exact<{ [key: string]: never; }>;


type TeamImagesQueryQuery = { readonly pavel: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly vasko: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly lyubo: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }>, readonly vlado: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> };

type VarvaraQueryQueryVariables = Exact<{ [key: string]: never; }>;


type VarvaraQueryQuery = { readonly mdx: Maybe<Pick<Mdx, 'body'>> };

type AdvicesQueryQueryVariables = Exact<{ [key: string]: never; }>;


type AdvicesQueryQuery = { readonly mdx: Maybe<Pick<Mdx, 'body' | 'tableOfContents'>> };

type OrgImagesQueryQueryVariables = Exact<{ [key: string]: never; }>;


type OrgImagesQueryQuery = { readonly alabak: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, readonly bikearea: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, readonly mtbBg: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, readonly kriva: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, readonly vratsa: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }> };
