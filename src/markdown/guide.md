...
За да има координираност между маркиращите организации, и за да се осигури съответствие със стандарта и високо качество на крайния продукт, е наложително да се избере настояща, или да се създаде нова, национална организация, която да обединява организациите, желаещи да маркират районите, които поддържат.
...
Маркирането на тематичен маршрут е допустимо само по изключение, защото наслагването на повече такива маршрути в един и същи район води до пренасищане с маркировъчни знаци, а понякога и до объркване за потребителите.
...
![Триъгълници за тематични маршрути - пример за Витоша 100](../images/guide/tematic-signs.png)

![Триъгълници за тематични маршрути - пример за Ком - Емине](../images/guide/tematic-signs2.png)
...
![Разклон](../images/guide/cross-sign.png)
...
*   знакът указващ грешен път на движение (бял квадрат с червен хикс) се поставя в изключителни случаи, когато е налице рязко отклонение на маршрута от досегашната или логична посока на движение. Поставя се и в открити местности или други места, където теренът не позволява нанасянето на ясна маркировка в правилната посока на движение; 
